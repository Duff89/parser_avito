...
### [3.2.22] - 2026-08-20
#### Исправлено
- Ссылки на провайдера прокси mobileproxy.space изменены на mobileproxy.rent (зеркало, доступное без впн)
- Ссылки на spfa.ru изменены на spfa.pro
- Добавлено уведомление, что теперь прокси необходим при использовании сервиса spfa
- Обновлен .gitignore
...
### [3.2.20] - 2026-08-09
#### Исправлено
- Теперь парсинг через spfa осуществляется через мобильный api. Парсер адаптирован под новые условия

#### Добавлено
- purchase_cooldown - как часто (по-умолчанию 600сек) можно покупать новые cookies, специально заведен параметр, чтобы при сбое
со стороны spfa у Вас не сжигался бюджет. Если с парсингом всё ок - то новые cookies не покупаются, пока всё работает

### [3.2.16] - 2026-06-30
#### Исправлено
- Ошибка валидации Field required type missing

### [3.2.15] - 2026-06-15
- Улучшена стабильность работы (меньше блокировок) во всех режимах
- Снова работает отправка уведомлений в ВК
- Обновлена документация [Обход блокировок](docs/ANTIBLOCK.md) и [Уведомления (Telegram, VK)](docs/NOTIFICATIONS.md)

### [3.2.14] - 2026-05-03
#### Исправлено
- Улучшена стабильность работы (меньше блокировок) во всех режимах работы
