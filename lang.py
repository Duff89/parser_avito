...
TG_CHAT_ID_HELP = "Chat_id - id конкретно Вашей беседы, можно вставить несколько (если несколько получателей)"
...
ONE_TIME_START_HELP = "(Еще недоступно, это будущая фича) После завершения парсинга программа сама закроется, повторных запусков не будет. Удобно," \
